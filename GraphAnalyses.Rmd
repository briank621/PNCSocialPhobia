...
small.dt = readRDS(file.path(savedir,'GAALMotion.small.dt.rds'))
```
...
```{r}
saveRDS(regionalResults, file=file.path(savedir, 'AAL.regionalResults.rds'), compress='xz')
```

```{r}
regionalResults = readRDS(file.path(savedir,'GAAL.regionalResults.rds'))
```
