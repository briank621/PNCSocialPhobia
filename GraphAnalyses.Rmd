...
```{r}
savedir = "/Users/brian/Documents/classes/quantitativepsych/PNCSocialPhobia/savedGraphs"
...
for(metric in metrics){
    result = computeAUC(dt.g.all.sub.graph, covars.fmri, thresholds, metric, "Study.ID")
...
saveRDS(small.dt, file=file.path(savedir, 'adhd.small.dt.rds'), compress='xz')
```
...
for(index in 1:length(metrics)){
    ...
    spList = AUCResults[status=="SPADHD" | status=="SP"][[metric]]
