...
```{r}
longAUC = melt(AUCResults, id.vars=c("SUBJID", "status", "rowNumber", "smry_soc", "Sex", "age_at_cnb"))
...
for(i in 1:length(groupings)){
  ...
  generateBrainnetViewer(116, fcResults$significantPValues, paste(prefixPath, 'Significant', groupName, sep=''))
  generateBrainnetViewer(116, fcResults$uncorrected, paste(prefixPath, 'Uncorrected', groupName, sep=''))
}
