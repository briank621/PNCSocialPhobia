...
```{r}
spADHD = subset[smry_soc>=3&smry_add>=3]#&smry_mood_cat<=2&smry_eat_cat<=2&smry_gad<=2&smry_sep<=2&smry_phb<=2&smry_pan<=2&smry_agr<=2&smry_ocd<=2&smry_ptd<=2&smry_psy_cat<=2&smry_add>=3]
...
combined = combined[,.(bblid, SUBJID, Sex, age_at_cnb, smry_soc, smry_add, status)]
